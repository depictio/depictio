...
- **#924** (open) : time travel des données, deux axes (layout x données), picker de version par collection, historique et compare par composant, preview qui épingle les données. +30k, 200 fichiers, porte #915 + #919. Une branche parallèle (versioning, étapes 3 à 5, 41 commits) reste à réconcilier.
