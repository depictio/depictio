    ...
    dbc.Form([
        dbc.Row([
            dbc.Col([
                ...
                dbc.Input(type="text", id="register-username", placeholder="Enter username")
            ], width=12)
        ], className="mb-3"),
        dbc.Row([
            dbc.Col([
    ...
    dbc.Row([
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody([
                    html.P("This is your main dashboard. You are successfully logged in."),
                    html.P("This example demonstrates how to integrate Flask authentication with Plotly Dash."),
            ...
            dbc.Card([
                ...
                dbc.CardBody([
                    ...
                    html.Div([
                        ...
                        html.P("Reports Generated", className="d-inline ml-2")
                    ])
                ])
            ])
        ], md=6)
...
admin_layout = dbc.Container([
    ...
    dbc.Card([
        ...
        dbc.CardBody([
            html.P("This panel allows you to manage users in the system. You can view all registered users and delete them if needed."),
...
def register_user_callback(n_clicks, username, email, password):
    ...
    if data.get('success'):
        return dbc.Alert("Registration successful! Redirecting to login...", color="success"), '/login'
    else:
...
def load_user_table(pathname):
    ...
    for user in users:
        ...
        ) if user['id'] != int(current_user.get_id()) else html.Span("Current User", className="text-muted")
...
def delete_user_callback(n_clicks_list, button_ids):
    ...
    if data.get('success'):
        ...
        if not users_data.get('success'):
            return dbc.Alert(data.get('message', 'User deleted successfully'), color="success"), no_update
        ...
        return dbc.Alert(data.get('message', 'User deleted successfully'), color="success"), table_header + table_body
