...
class MultiQCParser:
    ...
    def get_raw_data(self, module=None, sample=None, metric=None):
        ...
        for mod in modules_to_process:
            ...
            samples_to_process = [sample] if sample else self.data['report_saved_raw_data'][mod].keys()
        ...
        for mod in modules_to_process:
            ...
            for sample in self.data['report_saved_raw_data'][mod]:
                ...
                for metric in all_metrics:
                    sample_data[metric] = self.data['report_saved_raw_data'][mod][sample].get(metric, None)
