    ...
    for sample_file in sample_files:
        ...
        with open(file_path, 'w', newline='') as f:
            ...
            for metric in metrics:
                ...
                varied_metric = [
                    metric[0],
                    metric[1] * random.uniform(0.9, 1.1) if isinstance(metric[1], (int, float)) else metric[1],
                    metric[2]
                ]
...
def main():
    ...
    parser.add_argument("--output", "-o", default="depictio_example_project",
                        help="Output directory for the example project")
    parser.add_argument("--home", default=None,
                        help="User home directory to use in the configuration")
