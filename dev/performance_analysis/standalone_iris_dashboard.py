...
def create_app() -> Dash:
    ...
    app = Dash(
        ...
        assets_folder="dev/performance_analysis/assets"
    )
    ...
    def update_interactive_values_store(values, component_ids, metadata_ids, metadata_list):
        ...
        print("=" * 80, flush=True)
        print("[Interactive Store] CALLBACK FIRED", flush=True)
                ...
                children=[
                    ...
                    dmc.AppShellMain(
                        children=[
                            ...
                            # Performance monitoring script loaded from assets/performance-monitor.js
                        ]
                    ),
                ],
                header={"height": 60},
