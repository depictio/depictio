...
class SecureCodeExecutor:
    ...
    ALLOWED_IMPORTS = {
        'pandas': ['DataFrame', 'Series', 'concat', 'merge', 'pivot_table', 'crosstab', 'cut', 'qcut'],
        'plotly.express': ['*'],  # All plotly express functions are allowed
        'plotly.graph_objects': ['Figure', 'Scatter', 'Bar', 'Line', 'Histogram', 'Box', 'Violin', 'Pie'],
        'numpy': ['array', 'arange', 'linspace', 'mean', 'std', 'min', 'max', 'sum', 'count_nonzero'],
    ...
    def execute_code(self, code: str) -> tuple[bool, Any, str]:
        ...
        try:
            ...
            if fig is None:
                return False, None, "No Plotly figure found in code. Make sure to create a figure object."
    ...
    app.layout = dmc.MantineProvider(
        ...
        children=[
            dmc.Container(
                size="xl",
                children=[
                    dmc.Title("Plotly Code Prototype", order=1, style={"textAlign": "center", "margin": "20px"}),
                            ...
                            dmc.Card([
                                ...
                                dmc.CardSection([
                                    ...
                                    dmc.List([
                                        ...
                                        dmc.ListItem("plotly.graph_objects as go"),
                                        dmc.ListItem("numpy functions (math operations)"),
                                    ])
                                ], withBorder=True, inheritPadding=True, py="xs"),
