...
def create_sample_datasets() -> Dict[str, pd.DataFrame]:
    ...
    datasets['scatter'] = pd.DataFrame({
        ...
        'category': ['A', 'B'] * 10,
        'size': [10, 20, 15, 25, 30, 12, 18, 22, 14, 28, 32, 35, 25, 40, 38, 28, 42, 30, 36, 45],
        ...
        children=[
            dmc.Container(
                ...
                children=[
                    # Header
                    dmc.Paper([
                        dmc.Title("🚀 Plotly Code Prototype", order=1, style={"textAlign": "center"}),
                        dmc.Text("Secure Python/Plotly code execution with real-time visualization", 
                                style={"textAlign": "center"}, c="dimmed"),
                        dmc.Space(h=10),
                        dmc.Group([
                    ...
                    dmc.Group([
                        dmc.Stack([
                            ...
                            dmc.Select(
                                ...
                                data=[{"label": k, "value": k} for k in code_examples.keys()],
                                style={"marginBottom": "10px", "width": "300px"}
                            ),
                        ], gap="xs"),
                        dmc.Stack([
                    ...
                    dmc.Stack([
                        ...
                        dmc.Card([
                            dmc.CardSection([
                                ...
                                dmc.Paper([
                                    ...
                                    dmc.Group([
                                        dmc.Group([
                                            dmc.Box(style={"width": "12px", "height": "12px", "borderRadius": "50%", "backgroundColor": "#ff5f57"}),
                                            dmc.Box(style={"width": "12px", "height": "12px", "borderRadius": "50%", "backgroundColor": "#ffbd2e"}),
                                            dmc.Box(style={"width": "12px", "height": "12px", "borderRadius": "50%", "backgroundColor": "#28ca42"}),
                                        ], gap="xs"),
                                        dmc.Text("main.py", size="sm", c="dimmed", style={"fontFamily": "monospace"}),
                                        dmc.Group([
                                            dmc.Text("Python", size="xs", c="dimmed"),
                                            dmc.Text("UTF-8", size="xs", c="dimmed"),
                                        ], gap="md"),
                                    ...
                                    id='editor-container'
                                    ) if ACE_AVAILABLE else dmc.Textarea(
                                        id="code-input",
                                ...
                                radius="md",
                                withBorder=True,
                                style={"backgroundColor": "#2d3748", "overflow": "hidden"}),
                            ], p="lg"),
                        ], mb="xl"),
                        ...
                        dmc.Card([
                            dmc.CardSection([
                                dmc.Title("📈 Generated Visualization", order=3, mb="md"),
                                dcc.Graph(
                                    id="output-graph",
                        ...
                        dmc.Accordion([
                            dmc.AccordionItem([
                                dmc.AccordionControl([
                                    dmc.Group([
                                        dmc.Title("📊 Dataset Information", order=4),
                                        dmc.Text(id="dataset-info", size="sm", c="dimmed"),
                                    ], justify="space-between")
                                ]),
                                dmc.AccordionPanel([
                    ...
                    dmc.Paper([
                        ...
                        dmc.Group([
                            dmc.Text("✅ Only safe Python/Plotly operations allowed", size="sm"),
                    ...
                    ], p="md", radius="md", withBorder=True, style={"backgroundColor": "#f8f9fa"}),
