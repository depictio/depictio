...
app.layout = dbc.Container(
    [
        ...
        dbc.Row(dbc.Col(html.P("Security tokens to access Seqera Cloud via API."), width=12)),
        dbc.Row(
            dbc.Col(
                dbc.Button(
                    "Add Token",
        ...
        dmc.Modal(
            ...
            children=[
                dmc.TextInput(
                    id="delete-confirm-input", label="Type 'delete' to confirm", required=True
                ),
                dmc.Button(
                    "Confirm Delete", id="confirm-delete-button", className="mt-2", color="danger"
                ),
            ],
        ),
        dmc.Modal(
