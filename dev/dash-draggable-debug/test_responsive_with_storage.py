...
def create_responsive_storage_test():
        ...
        [
            ...
            html.Div(
                [
                    ...
                    html.P(
                        "🎯 This component accepts 'id' prop and should work with ResponsiveGridLayout"
                    ),
                    html.P(
                        "💾 Session storage: Check browser DevTools -> Application -> Session Storage"
                    ),
                ]
            ),
    ...
    @app.callback(
        [Output("responsive-output", "children"), Output("session-storage", "data")],
    ...
    def update_layout_and_storage(layouts):
        ...
        # Overall status
        overall_status = (
            "✅ SUCCESS: All UUIDs preserved!"
            if all_uuid_preserved
            else "❌ FAILURE: Some UUIDs lost"
        )
    ...
    @app.callback(Output("storage-display", "children"), Input("session-storage", "data"))
