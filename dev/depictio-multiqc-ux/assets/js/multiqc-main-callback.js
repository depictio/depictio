...
window.dash_clientside = Object.assign({}, window.dash_clientside, {
    multiqc: Object.assign(window.dash_clientside.multiqc || {}, {
        ...
        handleMultiQCCallback: function(
            inspect_clicks, inspect_showhide_clicks, test_clicks, plus_clicks, apply_clicks, test_hide_plus_clicks, test_hide_apply_clicks, enter_clicks,
            ...
            try {
                ...
                switch (triggered_id) {
                    case 'inspect-highlight-btn':
                        return window.dash_clientside.multiqc.testSampleInput();
                        
                    case 'inspect-showhide-btn':
                        return window.dash_clientside.multiqc.inspectShowHideSection();
                    ...
                    case 'test-hide-plus-btn':
                        return window.dash_clientside.multiqc.clickHidePlusButton();
                        
                    case 'test-hide-apply-btn':
                        return window.dash_clientside.multiqc.clickHideApplyButton();
                    ...
                    case 'showhide-clear-btn':
                        const hideClearResult = window.dash_clientside.multiqc.clearHideFilters();
                        return hideClearResult.message;
