...
def create_simple_app():
    ...
    select_component = html.Div([
        ...
        html.P(f"UUID: {uuid2[:8]}...", style={"marginTop": "20px", "fontSize": "12px", "color": "#666"})
    ])
    ...
    metrics_component = html.Div([
        ...
        html.P(f"UUID: {uuid3[:8]}...", style={"marginTop": "20px", "fontSize": "12px", "color": "#666"})
    ])
    ...
    def display_layout(current_layout):
        ...
        for i, item in enumerate(current_layout):
            component_type = component_types[i] if i < len(component_types) else f"Component {i+1}"
            layout_info.append(
                html.P([
