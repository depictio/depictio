...
def create_basic_app():
    ...
    app.layout = dmc.MantineProvider([
        ...
        html.Div([
            ...
            html.P("Toggle to enable/disable edit mode (shows/hides remove buttons and resize handles)", 
                   style={"fontSize": "12px", "color": "#666", "marginTop": "5px"})
        ], style={"background": "#f0f8ff", "padding": "15px", "margin": "10px 0", "border": "1px solid #ddd"}),
        
        # Storage for edit mode state
        dcc.Store(id="edit-mode-store", storage_type="memory", data=False),
        
        # Layout display
        html.Div(id="layout-display", style={"background": "#f5f5f5", "padding": "10px", "margin": "10px 0"}),
                ...
                dgl.DraggableWrapper(
                    children=[
                        html.Div([
                            ...
                            html.P("This is a text-based component that can be dragged and resized!")
                        ], style={
                            'height': '100%', 
                            'display': 'flex', 
                ...
                dgl.DraggableWrapper(
                    children=[
                        html.Div([
                            ...
                            html.Div([
                                dmc.Button("Button 1", color="blue", style={"margin": "5px"}),
                                dmc.Button("Button 2", color="green", style={"margin": "5px"}),
                                dmc.Button("Button 3", color="orange", style={"margin": "5px"}),
    ...
    def display_layout(current_layout):
        ...
        layout_info.append(
            html.Details([
                html.Summary("Click to see JSON"),
                html.Pre(json.dumps(current_layout, indent=2))
            ])
        )
