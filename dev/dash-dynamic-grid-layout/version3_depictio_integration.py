        ...
        [
            ...
            html.Div(
                [
                    ...
                    dmc.Text(
                        "Loading figure...", size="sm", c="dimmed", style={"marginLeft": "10px"}
                    ),
                ],
                style={
                    "display": "flex",
        ...
        [
            ...
            html.Div(
                [
                    ...
                    dmc.Text(
                        "Loading selector...", size="sm", c="dimmed", style={"marginLeft": "10px"}
                    ),
                ],
                style={
                    "display": "flex",
        ...
        [
            ...
            html.Div(
                [
                    ...
                    dmc.Text(
                        "Loading metrics...", size="sm", c="dimmed", style={"marginLeft": "10px"}
                    ),
                ],
                style={
                    "display": "flex",
...
def create_depictio_progressive_loading_app():
    ...
    def update_loading_status(loading_state):
        ...
        return html.Div([html.P(item, style={"margin": "2px 0"}) for item in status_items])
