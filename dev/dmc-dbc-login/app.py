            ...
            dmc.CardSection([
                ...
                dmc.Group([
                    ...
                    dmc.Button("Twitter",
                               ...
                               radius='xl',
                               variant='outline'),
                ], grow=True, mt='1rem', mb='1rem'),
                dmc.Divider(label="Or continue with email", 
                            variant='dashed',
                ...
                ], grow=True, mt='1.5rem', noWrap=True, spacing='apart')
            ], inheritPadding=True)
        ], withBorder=True, shadow='xl', radius='lg', p='1.5rem', style={'width': '420px'})
])
