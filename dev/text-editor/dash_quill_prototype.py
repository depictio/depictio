...
app.layout = dmc.MantineProvider([
    ...
    dmc.Card([
        dmc.CardSection([
            ...
            dmc.Group([
                dmc.Button("Add Text Component", id="add-text-btn", color="green", n_clicks=0),
            ...
            dmc.Group([
                dmc.Switch(label="Show Toolbar", id="show-toolbar-switch", checked=True),
                dmc.Switch(label="Enable Markdown", id="enable-markdown-switch", checked=True),
                dmc.Switch(label="Read Only", id="readonly-switch", checked=False),
            ], gap="md"),
        ], style={"padding": "1rem"})
    ], withBorder=True, style={"marginBottom": "20px"}),
...
def manage_text_components(add_clicks, clear_clicks, editor_values, 
                          show_toolbar, enable_markdown, readonly, components_data):
    ...
    try:
        if button_id == "clear-btn":
            ...
            editor_ids = [ctx.triggered[i]["prop_id"].split(".")[0] 
            ...
            editor = dq.Quill(
                ...
                modules={
                    "toolbar": [
                        ...
                        ["code-block", "link"],
                        ["clean"]
                    ] if comp_data["show_toolbar"] else []
                },
                # style={
                #     "minHeight": "200px",
                #     "marginBottom": "10px"
        ...
        debug_info = html.Div([
            ...
            html.P(f"Configuration: Toolbar={show_toolbar}, Markdown={enable_markdown}, ReadOnly={readonly}"),
            html.Details([
