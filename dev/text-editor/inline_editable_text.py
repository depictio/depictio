                    ...
                    dmc.Menu(
                        [
                            ...
                            dmc.MenuDropdown(
                                [
                                    dmc.MenuItem(
                                        "H1", id={"type": "h1-menu", "index": component_id}
                                    ),
                                    dmc.MenuItem(
                                        "H2", id={"type": "h2-menu", "index": component_id}
                                    ),
                                    dmc.MenuItem(
                                        "H3", id={"type": "h3-menu", "index": component_id}
                                    ),
                                    dmc.MenuItem(
                                        "H4", id={"type": "h4-menu", "index": component_id}
                                    ),
                                    dmc.MenuItem(
                                        "H5", id={"type": "h5-menu", "index": component_id}
                                    ),
                                    dmc.MenuDivider(),
                                    dmc.MenuItem(
                                        "Text", id={"type": "text-menu", "index": component_id}
                                    ),
                                ]
                            ),
                        ]
    ...
    [
        dmc.Container(
            [
                ...
                dmc.Text(
                    "Click on any text to edit directly. Use the format menu to change header levels.",
                    c="dimmed",
                ),
                dmc.Space(h="md"),
                dmc.Alert(
                ...
                dmc.Card(
                    [
                        ...
                        dmc.Text(
                            "This demonstrates how the inline editable text works as section delimiters.",
                            size="sm",
                        ),
                    ],
                    withBorder=True,
...
def toggle_edit_mode(title_clicks, edit_clicks, input_submit, input_blur, input_value, store_data):
    ...
    elif "edit-input" in trigger_id and (
