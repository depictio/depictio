"""Layout for the progressive filter prototype.

DMC 2.0 AppShell with sidebar for filter chain and main area for
                    ...
                    dmc.Container(
                        dmc.Stack(
                            [
                                ...
                                dcc.Store(id="next-filter-id", data=3),
                                # Summary badges row
                                dmc.Paper(
                                    dmc.Group(
                                        id="summary-badges",
                                ...
                                # Charts row: volcano (span 7) + funnel (span 5)
                                dmc.Grid(
                                    [
                                        dmc.GridCol(
                                            dmc.Paper(
