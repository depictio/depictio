...
async def create_group(group: GroupCreate, user: User = Depends(get_current_superuser)):
...
async def update_group(
    group_id: str, group_data: GroupUpdate, user: User = Depends(get_current_superuser)
):
...
async def add_user_to_group(
    user_id: str, group_id: str, current_user: User = Depends(get_current_superuser)
):
