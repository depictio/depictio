...
login_layout = html.Div([
    ...
    html.P('You need to be authenticated to view this dashboard.', style={'textAlign': 'center'}),
    html.Div([
        html.A('Go to Login Page', href='/login/', style={
...
dashboard_layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            html.Span(id='user-display', style={'marginRight': '15px', 'color': 'white'}),
        ...
        if len(parts) == 3:
            ...
            try:
                ...
                if is_admin_bool == is_admin_actual:
                    ...
                    return html.Div([
                        dcc.Store(id='auth-store', data=auth_data),
                        dashboard_layout
                    ])
            except User.DoesNotExist:
                pass
...
def toggle_admin_panel(auth_data):
    if auth_data and auth_data.get('authenticated', False) and auth_data.get('is_admin', False):
        ...
        admin_content = [
            ...
            html.A('Go to Django Admin', href='/admin/', target='_blank', style={
                'display': 'inline-block',
        ...
        return {'display': 'block', 'padding': '15px', 'backgroundColor': '#f9f9f9', 'border': '1px solid #ddd', 'borderRadius': '5px'}, admin_content
