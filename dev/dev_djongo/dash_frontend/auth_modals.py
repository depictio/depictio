        ...
        [
            ...
            dbc.ModalFooter(
                [
                    ...
                    dbc.Button("Close", id="login-close", className="ms-auto", color="secondary"),
    ...
    return dbc.Modal(
        [
            ...
            dbc.ModalFooter(
                [
                    dbc.Button(
                        "Login Instead", id="switch-to-login", className="me-auto", color="link"
                    ),
                    dbc.Button(
                        "Close", id="register-close", className="ms-auto", color="secondary"
                    ),
...
def auth_modals():
    ...
    """
    return html.Div([create_login_modal(), create_register_modal()])
