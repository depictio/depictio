...
from depictio.fastapi_backend.modules.workflow_endpoints.routes import workflows_endpoint_router
from depictio.fastapi_backend.modules.datacollections_endpoints.routes import datacollections_endpoint_router
