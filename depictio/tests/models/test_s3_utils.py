...
class TestS3Utils:
    ...
    class TestS3StorageChecks:
        ...
        def test_all_checks_pass(self, sample_s3_config):
            ...
            with patch("depictio.models.s3_utils.MinIOManager", return_value=mock_minio_manager), \
        ...
        def test_minio_manager_exception(self, sample_s3_config):
            ...
            with patch("depictio.models.s3_utils.MinIOManager", side_effect=Exception("Connection error")), \
                 patch("depictio.models.s3_utils.logger"):
        ...
        def test_suggest_adjustments_exception(self, sample_s3_config):
            ...
            mock_minio_manager = MagicMock()
            mock_minio_manager.suggest_adjustments.side_effect = Exception("S3 storage is not correctly configured")
