...
class TestConfigCommands:
    ...
    def base_patches(self):
        ...
        patches = [
            ...
            patch("os.path.expanduser", return_value="test-cli-config.yaml"),  # Mock any path expansion
    ...
    def mock_load_config(self, mock_config):
        ...
        with patch("depictio.cli.cli.utils.common.load_depictio_config", 
                  return_value=mock_config) as mock_func:
            yield mock_func
    ...
    class TestShowDepictioProjectMetadataOnServer:
        ...
        def test_success(self, command, cli_config_path, mock_load_config, base_patches):
            ...
            with patch("depictio.cli.cli.utils.api_calls.api_get_project_from_name", 
                      return_value=mock_project_metadata):
                result = command.run("show-depictio-project-metadata-on-server", 
