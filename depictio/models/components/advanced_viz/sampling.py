...
KIND_SAMPLING_POLICY: dict[AdvancedVizKind, SamplingPolicy] = {
    ...
    "sankey": "none",
    "phylogenetic": "none",
    # Benchmarking kinds. Each draws a summary of an already-tiny frame — one
    # point per callset, an ordered threshold sweep, a table of counts, a bar
    # per metric — so there is nothing to reduce, and a hash sample would shred
    # the sweep's ordering rather than merely coarsen it.
    "pr_benchmark": "none",
    "roc_pr_curve": "none",
