...
def register_callbacks_draggable(app):
    ...
    #     # TEMPORARILY DISABLED: remove-box-button Input (now handled by remove_component_simple.py)
    #     # Input(
    ...
    #     # remove_box_button_values,  # DISABLED: remove-box-button now handled by remove_component_simple.py
    ...
    #         logger.info("🚫 DRAGGABLE CALLBACK - Skipping on stepper page (no draggable component)")
    #         return dash.no_update, dash.no_update, dash.no_update, dash.no_update
    ...
    #         # TEMPORARILY DISABLED: Old remove-box-button handler
    #         # Replaced by simple patch-based callback in remove_component_simple.py
    #         # This old handler was using react-grid-layout approach (draggable_children, draggable_layouts)
    #         # which is incompatible with the new 2-panel DMC layout system
