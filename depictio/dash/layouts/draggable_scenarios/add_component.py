...
#         Output({"type": "component-container", "index": MATCH}, "children", allow_duplicate=True),
#         [
#             Input({"type": "btn-done", "index": MATCH}, "n_clicks"),
#         ],
#         [
#             State({"type": "component-container", "index": MATCH}, "children"),
...
def add_new_component(
    ...
    if add_button_nclicks:
        ...
        # return dynamic dummy html.Div ("TEST") with id = index
