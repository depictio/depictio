"""
Shared save utilities for MultiQC components.

This module provides reusable functions for saving MultiQC component metadata
...
def save_multiqc_to_dashboard(
    dashboard_id: str, component_metadata: dict, token: str, app_prefix: str = "dashboard"
) -> str:
    """
    Save or update MultiQC component in dashboard.

    This function handles the complete API interaction for saving MultiQC metadata:
    ...
    Args:
        ...
        component_metadata: Complete component metadata dict with MultiQC fields
                           (module, plot, dataset, s3_locations, metadata, etc.)
    ...
    Example:
        ...
        ...     "s3_locations": [...],
        ...     "metadata": {...},
        ...     # ... other MultiQC fields
        ... }
        >>> redirect_url = save_multiqc_to_dashboard(
    ...
    logger.info(f"💾 SAVE MULTIQC - Dashboard: {dashboard_id}, Component: {component_id}")
    ...
    try:
        ...
        logger.info(f"✅ SAVE MULTIQC SUCCESS - Component {component_id} saved")
...
__all__ = ["save_multiqc_to_dashboard"]
