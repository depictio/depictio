"""
Image Component Callbacks - Lazy Loading Pattern
...
def load_design_callbacks(app):
    """
    Lazy-load design and edit callbacks for image component.
    ...
    from .edit import register_image_edit_callback

    register_design_callbacks(app)
    register_image_edit_callback(app)
