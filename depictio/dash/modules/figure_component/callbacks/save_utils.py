"""
Shared save utilities for figure components.

This module provides reusable functions for saving figure component metadata
...
def save_figure_to_dashboard(
    dashboard_id: str, component_metadata: dict, token: str, app_prefix: str = "dashboard"
) -> str:
    """
    Save or update figure component in dashboard.

    This function handles the complete API interaction for saving figure metadata:
    ...
    Args:
        ...
        component_metadata: Complete component metadata dict with all figure fields
    ...
    try:
        ...
        logger.error(f"❌ SAVE FIGURE FAILED - Error: {e}")
