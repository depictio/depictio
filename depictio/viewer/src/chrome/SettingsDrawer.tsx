...
interface SettingsDrawerProps {
   ...
   *  this unset and the section is not rendered. */
 ...
 * editor — the writable dashboard defaults: the plot theme (#397), a Plotly
 * template and/or colorway applied as the default for every figure component,
 * and the funnel-filtering default (issue #939).
 *
