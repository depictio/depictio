...
const DashboardCard: React.FC<DashboardCardProps> = ({
  ...
  const isAiDraft = dashboard.ai_generation?.status === 'draft';
  ...
  return (
    ...
    >
      ...
      <Stack gap={4} align="flex-start">
        ...
        {isAiDraft && (
          <Tooltip label="Generated by the AI assistant and not yet reviewed" withinPortal>
            <Badge
              color={AI_COLOR}
              variant="light"
              size="sm"
              leftSection={<Icon icon={AI_ICON} width={12} />}
              data-testid="dashboard-card-ai-draft"
            >
              AI draft
            </Badge>
          </Tooltip>
