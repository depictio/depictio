"""MultiQC figure generation (extracted from depictio.dash.modules.figure_component.multiqc_vis).

Pure data processing — produces Plotly figure dicts the React viewer renders
