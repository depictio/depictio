...
Relocated from ``depictio.dash.modules.figure_component.models`` so that
backend services (Celery tasks, FastAPI routes) can use the figure
parameter models without pulling in the Dash UI layer.
"""
