"""Map figure rendering (extracted from depictio.dash.modules.map_component.utils).

Produces Plotly figures + data-info dicts from a DataFrame + trigger config.
The Dash-side `build_map` skeleton stays with the dash/ tree.
"""
