...
from depictio.api.v1.endpoints.components_endpoints.routes import components_endpoint_router
...
# Include Google OAuth routes separately
router.include_router(
    google_oauth_router,
    prefix="/auth/google",
    tags=["Google OAuth"],
