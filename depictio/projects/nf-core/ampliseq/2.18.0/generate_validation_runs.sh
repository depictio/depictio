#!/usr/bin/env bash
# Generate nf-core/ampliseq 2.18.0 validation runs for template generalization testing.
#
...
#   # Default TARGET_ROOT: ~/Data/depictio-nfcore/ampliseq/2.18.0
set -euo pipefail

TARGET_ROOT="${1:-$HOME/Data/depictio-nfcore/ampliseq/2.18.0}"

echo "=== nf-core/ampliseq 2.18.0 — generalization validation ==="
echo ""
