#!/usr/bin/env bash
# Download the nf-core/airrflow 5.1.0 AWS megatest subset for local testing.
...
#   Default TARGET_DIR: ~/Data/depictio-nfcore/airrflow/5.1.0/megatest
set -euo pipefail
exec python3 "$(dirname "$0")/../../../../../scripts/nfcore_megatest.py" fetch \
  --pipeline airrflow --version 5.1.0 \
  --dest "${1:-$HOME/Data/depictio-nfcore/airrflow/5.1.0/megatest}"
