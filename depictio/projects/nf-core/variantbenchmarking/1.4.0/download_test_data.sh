...
echo "depictio recipe run rtgtools/vcfeval_summary.py -d $TARGET"
echo "depictio recipe run happy/summary.py -d $TARGET"
echo "depictio recipe run sompy/summary.py -d $TARGET"
echo "depictio recipe run sompy/regions.py -d $TARGET"
echo ""
