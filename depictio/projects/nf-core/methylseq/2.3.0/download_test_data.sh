#!/usr/bin/env bash
# Download the nf-core/methylseq 2.3.0 AWS megatest subset for local testing.
...
#   Default TARGET_DIR: ~/Data/depictio-nfcore/methylseq/2.3.0/megatest
set -euo pipefail
exec python3 "$(dirname "$0")/../../../../../scripts/nfcore_megatest.py" fetch \
  --pipeline methylseq --version 2.3.0 \
  --dest "${1:-$HOME/Data/depictio-nfcore/methylseq/2.3.0/megatest}"
