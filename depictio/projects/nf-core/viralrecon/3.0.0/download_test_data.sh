...
echo "depictio-cli run --template nf-core/viralrecon/3.0.0 --data-root $TARGET --dry-run"
echo ""
echo "# 2. Full run (needs a reachable server and ~/.depictio/CLI.yaml)"
echo "depictio-cli run --template nf-core/viralrecon/3.0.0 --data-root $TARGET"
