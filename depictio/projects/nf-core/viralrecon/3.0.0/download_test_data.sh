...
echo "depictio recipe run multiqc/summary_metrics.py -d $RUN_DIR"
echo "depictio recipe run ivar/variants_long.py -d $RUN_DIR"
echo "depictio recipe run pangolin/pangolin_lineages.py -d $RUN_DIR"
echo "depictio recipe run nextclade/nextclade_results.py -d $RUN_DIR"
echo ""
