...
<details>
<summary>Click to expand the changelog for 0.1.0</summary>

### Changes 📜

#### New Features ✨

* feat: Update type checker and CLI configuration to include 'cli' folder, enhance API base URL handling [ebaf2690]
* feat: Enhance type checking and user session handling across multiple components [57f1025b]
* feat: Add comprehensive S3 backup strategy tests and MinIO configuration [52ccbac7]
* feat: Update type checker and CLI configuration to include 'cli' folder, enhance API base URL handling [0bca420b]
* feat: Enhance type checking and user session handling across multiple components [c30e68f7]
* feat: Implement S3 backup strategy manager and update related configurations [92ce14ff]
* feat: Update BackupConfig paths and enhance S3 location handling in backup endpoints [47f96c3d]
* feat: Register backup commands in the CLI [00c53216]
* feat: Add backup and restore commands with validation and S3 integration [c126e407]
* feat: Implement backup and restore endpoints with S3 integration and MongoDB backup functionality [5faf1d1a]
* feat: Add BackupConfig for backup and restore settings with S3 integration [b67703b5]
* feat: Implement project-based permissions for dashboards and enhance dashboard management UI [b7fd2994]
* feat: Enhance project permissions tests with improved logout handling and user restriction verifications [a2c0170d]
* feat: Add user management tests and project permissions E2E tests [9f3d308a]
* feat: add workflow uniqueness validation for project creation and updates [ef17792b]
* feat: enhance iterative_join with post-join filtering for interactive components [ef5cfcbc]
* feat: add configuration option for unauthenticated mode in environment file [4b590d04]
* feat: add unauthenticated mode and permanent tokens [6aa815f1]
* feat: add configuration for unauthenticated mode with automatic anonymous login [ee402249]
* feat: implement caching for iterative joins and join tables to enhance performance [78a7704a]
* feat: implement caching for component data, workflows, and data collection specs to enhance performance [cc7d7dbe]
* feat: add configuration option for unauthenticated mode in environment file [4f363416]
* feat: implement temporary user functionality with session management and upgrade options [38ff59d7]
* feat: implement temporary user creation and cleanup functionality with session management [6caf2863]
* feat: add configuration for unauthenticated mode with automatic anonymous login [56abb9d5]
* feat: enhance unauthenticated mode by integrating anonymous user session handling and public access for dashboards, workflows, and data collections [7622d11f]
* feat: implement anonymous user session handling and update UI components for unauthenticated mode [a5d70429]
* feat: add unauthenticated mode configuration with default anonymous user settings and related tests [2699dd79]
* feat: add support for unauthenticated mode with anonymous user and permanent tokens [8b09c178]
* feat: Add support for temporary user expiration in hours and minutes [4941b9ac]
* feat: Add support for temporary user expiration in hours and minutes [6e148404]
* feat: Enable unauthenticated mode in CI workflow and update environment variable [787ee6b2]
* feat: Implement unauthenticated mode e2e tests [ac2d2a20]
* feat: enhance user experience for anonymous users by updating dashboard creation and profile login prompts [ca4ed12d]
* feat: Add infrastructure diagnostics module and enhance dashboard health checks; update performance settings for screenshot capture [86d7e108]
* feat: Implement environment-specific timeout settings for API calls and enhance dashboard data handling ; refactor some API calls into functions [a54c9734]
* feat: Enhance service readiness and navigation strategies with environment-specific performance settings [5c14eea7]
* feat: Add PerformanceConfig class and optimize timeout settings for production environments [0be1e30e]
* feat: Implement hybrid navigation strategy with enhanced network activity logging [eeb31d65]
* feat: Enhance screenshot endpoint with service readiness checks and retry logic [256952f6]
* feat: implement caching for iterative joins and join tables to enhance performance [5137b96b]
* feat: implement caching for component data, workflows, and data collection specs to enhance performance [b0050f7b]
* feat: Add internal API key handling in AuthConfig with environment variable support [9a631430]
* feat: Add wait-for-api-key container to ensure API key file generation before startup [a09e517f]
* feat: add configuration option for unauthenticated mode in environment file [2efaf96e]
* feat: implement temporary user functionality with session management and upgrade options [7665bfa7]
* feat: implement temporary user creation and cleanup functionality with session management [da7cb979]
* feat: add configuration for unauthenticated mode with automatic anonymous login [97cc6a51]
* feat: enhance unauthenticated mode by integrating anonymous user session handling and public access for dashboards, workflows, and data collections [331dad63]
* feat: implement anonymous user session handling and update UI components for unauthenticated mode [99b523af]
* feat: add unauthenticated mode configuration with default anonymous user settings and related tests [1c7db4cb]
* feat: add support for unauthenticated mode with anonymous user and permanent tokens [f921941d]
* feat: optimize component data retrieval with MongoDB aggregation for improved performance and access control [5f7c180e]
* feat: implement caching for user data in API calls to reduce redundant requests [3c3f7f9a]
* feat: add CLAUDE.md for development guidance and architecture overview [9eabb2c2]
* feat: add unauthenticated mode and permanent tokens [29761633]
* feat: enhance screenshot generation test with improved timeout handling and connectivity checks [e596e6da]
