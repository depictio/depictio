...
<details>
<summary>Click to expand the changelog for 0.1.0-b8</summary>

### Changes 📜

#### New Features ✨

* feat: enhance iterative_join with post-join filtering for interactive components [ef5cfcb]
* feat: add configuration option for unauthenticated mode in environment file [4b590d0]
* feat: add unauthenticated mode and permanent tokens [6aa815f]
* feat: add configuration for unauthenticated mode with automatic anonymous login [ee40224]
* feat: implement caching for iterative joins and join tables to enhance performance [78a7704]
* feat: implement caching for component data, workflows, and data collection specs to enhance performance [cc7d7db]
* feat: add configuration option for unauthenticated mode in environment file [4f36341]
* feat: implement temporary user functionality with session management and upgrade options [38ff59d]
* feat: implement temporary user creation and cleanup functionality with session management [6caf286]
* feat: add configuration for unauthenticated mode with automatic anonymous login [56abb9d]
* feat: enhance unauthenticated mode by integrating anonymous user session handling and public access for dashboards, workflows, and data collections [7622d11]
* feat: implement anonymous user session handling and update UI components for unauthenticated mode [a5d7042]
* feat: add unauthenticated mode configuration with default anonymous user settings and related tests [2699dd7]
* feat: add support for unauthenticated mode with anonymous user and permanent tokens [8b09c17]
* feat: Add support for temporary user expiration in hours and minutes [4941b9a]
* feat: Add support for temporary user expiration in hours and minutes [6e14840]
* feat: Enable unauthenticated mode in CI workflow and update environment variable [787ee6b]
* feat: Implement unauthenticated mode e2e tests [ac2d2a2]
* feat: enhance user experience for anonymous users by updating dashboard creation and profile login prompts [ca4ed12]
* feat: Add infrastructure diagnostics module and enhance dashboard health checks; update performance settings for screenshot capture [86d7e10]
* feat: Implement environment-specific timeout settings for API calls and enhance dashboard data handling ; refactor some API calls into functions [a54c973]
* feat: Enhance service readiness and navigation strategies with environment-specific performance settings [5c14eea]
* feat: Add PerformanceConfig class and optimize timeout settings for production environments [0be1e30]
* feat: Implement hybrid navigation strategy with enhanced network activity logging [eeb31d6]
* feat: Enhance screenshot endpoint with service readiness checks and retry logic [256952f]
* feat: implement caching for iterative joins and join tables to enhance performance [5137b96]
* feat: implement caching for component data, workflows, and data collection specs to enhance performance [b0050f7]
* feat: Add internal API key handling in AuthConfig with environment variable support [9a63143]
* feat: Add wait-for-api-key container to ensure API key file generation before startup [a09e517]
* feat: add configuration option for unauthenticated mode in environment file [2efaf96]
* feat: implement temporary user functionality with session management and upgrade options [7665bfa]
* feat: implement temporary user creation and cleanup functionality with session management [da7cb97]
* feat: add configuration for unauthenticated mode with automatic anonymous login [97cc6a5]
* feat: enhance unauthenticated mode by integrating anonymous user session handling and public access for dashboards, workflows, and data collections [331dad6]
* feat: implement anonymous user session handling and update UI components for unauthenticated mode [99b523a]
* feat: add unauthenticated mode configuration with default anonymous user settings and related tests [1c7db4c]
* feat: add support for unauthenticated mode with anonymous user and permanent tokens [f921941]
* feat: optimize component data retrieval with MongoDB aggregation for improved performance and access control [5f7c180]
* feat: implement caching for user data in API calls to reduce redundant requests [3c3f7f9]
* feat: add CLAUDE.md for development guidance and architecture overview [9eabb2c]
* feat: add unauthenticated mode and permanent tokens [2976163]
* feat: enhance screenshot generation test with improved timeout handling and connectivity checks [e596e6d]
