...
<details>
<summary>Click to expand the changelog for 0.6.0-b4</summary>

### Changes 📜

#### New Features ✨

* feat: integrate component type validation in watcher and CLI [a0476892]
* feat: add component type validation setting to dashboard YAML config [f240c7dc]
* feat: add extended validation for chart types, aggregations, and filters [6b44021a]
* feat: add centralized validation rules for dashboard components [7ecfe0f3]
* feat: add column name validation for YAML dashboards [f0e48c23]
* feat: add validation integration and CLI tools [12e79a07]
* feat: add Pydantic-based YAML dashboard validation [1fe7b941]
* feat: enhance YAML watcher and dashboard settings [3ec2a321]
* feat: add Claude Code custom skills for development workflows [ea6a691c]
* feat: add YAML dashboard configuration settings and fix key generation [11d3a3b2]
* feat: enhance YAML serialization with tag enrichment and modularization [d26b4da7]
* feat: add Plotly figure customization system with YAML support [e3cb2455]
* feat: add auto-sync between YAML directory and MongoDB [991c3158]
* feat: add YAML directory management for dashboard files [93f5a792]
* feat: add MongoDB ↔ YAML bidirectional dashboard serialization [d322a24e]
* feat: add auto-sync between YAML directory and MongoDB [e223663e]
* feat: add YAML directory management for dashboard files [a93763fa]
* feat: add MongoDB ↔ YAML bidirectional dashboard serialization [332f65a9]
* feat: enable project data collections and permissions callbacks [9f26cf2e]
* feat: enhance MultiQC component styling for flexbox compatibility [f3e97c67]
* feat: enable MultiQC component in dashboard system [0a8b4431]
* feat: add MultiQC component callback infrastructure [535bb9cc]
* feat: add MongoDB, Redis, MinIO as pixi dependencies for fully local dev [4e4d2289]
* feat: simplify dependencies with uv-based Dockerfiles and pixi support [149baf3d]
* feat: add CSV export functionality to table component with download and notification support [0265597c]
* feat: restore table component design and edit mode functionality [a3c82e0c]
* feat: enhance table component with pagination support in infinite scroll [848a882d]
* feat: enable table component callbacks in dashboard viewer and editor [07fe4a3d]

#### Bug Fixes 🐛

* fix: adjust font size and dimensions for ace editor in code mode for figure component [7633bfe3]
* fix: fetch cols_json dynamically for table components in view mode [292488ca]
* fix: interactive component filtering on joined DC figures [c1e551e8]
* fix: handle Plotly marker object correctly in highlighting [049b58ed]
* fix: add skip_enrichment parameter to bypass aggregation pipeline [62d5643e]
* fix: add final cleanup stage to filter incomplete data collections [6706d745]
* fix: filter out nulls and incomplete data collections in  stage [450b440e]
* fix: strengthen aggregation pipeline filter for incomplete data collections [6e25fe18]
* fix: use simple query for project CRUD operations instead of aggregation pipeline [284ee7df]
* fix: filter out incomplete data collections in aggregation pipeline [0d253985]
* fix: use ProjectResponse for all Project.from_mongo calls in API [99f27f5c]
* fix: use ProjectResponse for permission updates in API [bee5e786]
* fix: resolve project data manager and permissions manager errors [6ecf364a]
* fix: use ProjectResponse for aggregated project data [df1bfcda]
* fix: register MultiQC callbacks in both viewer and editor apps [d0fec49d]
* fix: preserve user-resized dimensions for interactive components in dual-panel layout [a750ac98]
* fix: remove overflow hidden from app shell root for proper scrolling [22f28695]
* fix: correct Claude Code settings schema URL [3757aeda]
* fix: enhance devcontainer setup with database extension configuration and random theme selection [e509ef30]
* fix: update devcontainer configuration and disable Celery integration for development [a46ad3fd]

#### Improvements 🚀

* refactor: simplify cross-DC filtering code and extract shared utilities [ba64b537]
* refactor: migrate Iris dashboard to flattened YAML structure [ac294047]
* refactor: flatten visualization config structure for MVP YAML format [373e9b6b]
* refactor: modularize YAML serialization with MVP format enhancements [4ec8ae80]
* refactor: simplify joined DC filtering and reduce log verbosity [49ee1599]
* refactor: modularize API main.py into focused service modules [bf7b29dc]
* refactor: simplify code for clarity and maintainability [33f1befc]
* refactor: modularize table component callbacks into dedicated modules [09293115]

#### Chores 🧹

* chore: update gitignore for YAML system files [0d058bf1]
* chore: update dashboard YAML examples [b1725761]
* chore: update Docker configuration for YAML system [08853993]
* chore: clean up temporary test files and update gitignore [40a20c60]
* chore: update uv.lock [b1f2e714]
* chore: update uv.lock after merge [7e7bd65e]
* ci: use uv-based Dockerfile and add pixi installation test [9f0dccae]
* chore: reduce debug logging noise in draggable layout [6d70cae3]
* chore: update Claude Code configuration and command templates [8e9c7c4e]

#### Documentation Updates 📚

* docs: add MVP YAML system fix documentation [643e238f]
* docs: add feature exploration for declarative config, MCP, and sandbox alternatives [d15a6edc]
* docs: add feature exploration for declarative config, MCP, and sandbox alternatives [0138cc4f]

#### Other Changes 📝

* Bump version: 0.6.0-b3 → 0.6.0-b4 [c7a78c15]
* fix(cli): correct HTTP status code checks for link create/delete [21b4c918]
* feat(links): implement universal DC linking system for cross-DC filtering [856ee6fe]
* feat(figure): enable bidirectional editor resize and increase font size [0317f4d4]
* fix(figure): enable ace editor resize and apply theme to code mode previews [5ffc350b]
* feat(figure): fix code mode save/render bug and add edit mode support [4fc2ac16]
* fix(figure): use initial_duplicate for mode switch callback with allow_duplicate outputs [29a163ae]
* fix(figure): place code mode preview in left panel with proper visibility control [5697a25b]
* fix(figure): use existing preview graph instead of creating duplicate [41ea1955]
* feat(figure): add live preview graph for Execute Code button [fb8e92a4]
* fix(figure): improve syntax error messages for code execution [9d617aa4]
* fix(figure): handle multi-line statements in code parser [b0aed457]
* fix(figure): fix copy-paste indentation and improve df validation [78318cec]
* fix(figure): fix Ace theme switching and relax code validation [a3632500]
* fix(figure): add Ace editor theme switching and Execute button functionality [dbc11d15]
* feat(figure): complete code mode refactor with view mode rendering [cf93f833]
* fix(profile): remove hardcoded colors for theme compatibility [7bebeb95]
* fix(auth): resolve triangle background animations not working [d22d8c85]
* feat(theme): add auth modal logo theme switching [95885dbe]
* fix(scripts): resolve shellcheck warnings in shell scripts [9b2d29ba]
* Update CHANGELOG.md for v0.6.0-b3 [163c68cf]
* Bump version: 0.6.0-b2 → 0.6.0-b3 [45803fa9]
* test: migrate join tests from server to CLI [33b75c29]
* debug: add comprehensive metadata flow logging for interactive components [3ec58552]
* debug(dash): add logging to trace interactive metadata flow [e9dceb14]
* fix(dash): use correct field names for interactive metadata [c10f0c7b]
* fix(dash): remove all scale/marks callback references [1903462e]
* fix(dash): add allow_duplicate to stored-metadata callback [3c454cb6]
* fix(dash): add stored-metadata-component Store for interactive save [c211f5a5]
* fix(dash): comment out scale type and marks inputs for interactive [9d0b1a96]
* fix(dash): make interactive preview components functional [2095ec19]
* fix(dash): resolve type errors in interactive preview callback [d2c8f9f1]
* fix(dash): import API_BASE_URL directly from config [d37c5da2]
* feat(dash): restore interactive component preview callback [50262ae1]
* fix(dash): use edit-page-context instead of current-edit-parent-index [44d781df]
* fix(dash): restore interactive component dropdown callbacks [b2055a13]
* docs(api): mark legacy join functions as deprecated [81cfda1d]
* refactor(dash): migrate components to use pre-computed joins [95c40abf]
* refactor(config): migrate join config from DC-level to project-level [6c3d8a00]
* feat(dash): fix duplicate joins and add row/column display [33c0d83c]
* feat(api): add shape endpoint for data collection metrics [7def1285]
* feat(api): implement project-level join system with workflow support [858ccb14]
* feat(cli): implement client-side joins with workflow-scoped DC references [7136509c]
* feat(models): add DataCollectionSource enum and improve validation [fc8136db]
* feat(cli): add client-side table joining with  command [c3c68084]
* fix(devcontainer): move port forwarding to postStartCommand for persistence [54cf48de]
* fix(devcontainer): use local CLI and add port forwarding for VS Code [d8f1ffa0]
* fix(devcontainer): use main depictio package instead of deprecated depictio-models [bbe23ec8]
* fix(devcontainer): fix CLI beanie dependency and improve port display [942538ed]
* fix(devcontainer): use port ranges for dynamic port allocation [3d9bfb3e]
* feat(devcontainer): auto-forward ports 5080, 8058, 9001 in Codespaces [8637fc0c]
* fix(devcontainer): set DOCKER_API_VERSION=1.43 for Codespaces compatibility [f036376a]
* fix(devcontainer): improve Docker socket access in Codespaces [f056532d]
* fix(devcontainer): fix UV cache permissions and pre-commit installation [e12e3e47]
* feat(devcontainer): add caching via pre-built GHCR image [35b075ae]
* fix(devcontainer): update base image to version 3.x (1.x is deprecated) [12813bce]
* fix(devcontainer): add missing setup_credentials.sh and fix platform compatibility [131f83e8]
* fix(deps): add typer and rich to main dependencies [6c1c3d30]
* fix(ci): fix shell escaping in pixi verify step [58703f2c]
* fix(pixi): remove xvfb-run dependency (not available on conda-forge) [52f852a0]
* fix(pixi): use correct syntax for platform-specific dependencies [291d20ce]
* fix(ci): disable automatic pixi install to capture actual errors [1f6fb0c2]
* fix(ci): fix pixi dependency resolution issues [289ac93b]
* fix(ci): update setup-pixi to v0.9.3 to fix post-cleanup ENOENT error [443e4f16]
* fix(ci): disable pixi cache until lockfile is committed [f6024c6d]
* 2026 [6c5cee18]
* 2026 [4dcc922d]
...
* refactor: Move build_sample_mapping utility to CLI utils to avoid code duplication and circular dependencies [00b1bc5a]
* refactor: Move partial data popover update callback to frontend.py for better synchronization [d87434ea]
* refactor: Comment out performance monitoring intervals in background effects and analytics layout [aa1ef144]
* refactor: Update layout dimensions for 48-column grid with ultra-fine precision [ae0e8241]
* refactor: Remove unused interactive components logic and streamline dashboard rendering [26a697b8]
* refactor: Simplify child component processing in render_dashboard function [1736e6e9]
* refactor: Simplify welcome and add component messages in draggable layout; enhance data availability checks for DeltaTables and MultiQC [bef4e66b]
* refactor: Move build_sample_mapping utility to CLI utils to avoid code duplication and circular dependencies [979bb766]
* refactor: Move partial data popover update callback to frontend.py for better synchronization [fb9a51dc]
* refactor: Comment out performance monitoring intervals in background effects and analytics layout [2569c20e]
* refactor: Update layout dimensions for 48-column grid with ultra-fine precision [427f2aee]
* refactor: Remove unused interactive components logic and streamline dashboard rendering [d2bb743f]
* refactor: Simplify child component processing in render_dashboard function [e8332399]
* refactor: Simplify welcome and add component messages in draggable layout; enhance data availability checks for DeltaTables and MultiQC [337558cc]
...
* refactor: Update MinIO and backend configurations for resource limits and security context [9e681bfc]
...
* Bump version: 0.3.1 → 0.3.2 [63afc920]
* Update CHANGELOG.md for v0.3.1 [ff5cb8e4]
* Bump version: 0.3.0 → 0.3.1 [ca93deba]
