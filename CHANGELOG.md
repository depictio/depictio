...
* feat: Enhance join logic to conditionally include depictio_run_id based on data collection metatypes [9d6ce2f4]
* feat: Remove limit on unique options in build_interactive and add display limit for multiselect component [59b23ac1]
* feat: Enhance filtering logic for boolean and unknown column types in build_table function [a5601c67]
* feat: Enhance reset functionality to preserve existing values on non-reset triggers [5ed0f4b1]
* feat: Add reset functionality for interactive components to restore default state [8b8fe616]
* feat: Refactor interactive component updates to utilize pattern-matching architecture for improved efficiency [43f90575]
* feat: Enhance component selection logic to route MultiQC data collections to the MultiQC component [4d60e89b]
* feat: Remove MultiQC mode support from figure component and update mode handling [ad21fd6c]
* feat: Implement multi-DC filtering support with iterative joins and enhanced logging [29547c22]
* feat: Add update functionality for MultiQC reports with S3 metadata preservation [6efb3adb]
* feat: Enhance filter handling with reset support and multi-DC filtering logic [e04b4f63]
* feat: Implement pattern-matching architecture for card component with async value computation and filter updates [d0260544]
* feat: Enhance multi-DC filtering support by grouping filters and merging dataframes for efficient loading [8f046d04]
* feat: Enhance figure rendering with trace metadata for efficient patching and interactive filtering [36a178c6]
* feat: Add column selection support for efficient data loading in _load_joined_deltatable and load_deltatable_lite functions [70c8a0de]
* feat: Add figure structure analysis and parameter extraction for efficient rendering and patching [ffa4cf22]
* feat: Update Celery configuration to conditionally include Redis password and simplify Dash background callback setup [e3272f9b]
* feat: Implement asynchronous figure rendering with pattern-matching callbacks and optimize caching for performance [9e6c0f91]
* feat: Implement caching for MultiQC report parsing to optimize plot generation and reduce redundant operations [15405255]
* feat: Implement background rendering for MultiQC plots and enhance loading experience with placeholder [4cc973b4]
* feat: Refactor MultiQC plot handling to include logo overlay at component level and improve layout management [8a3bd222]
* feat: Enhance MultiQC figure patching with trace metadata and improve plot analysis [c3bd9c62]
* feat: Add endpoint for cleaning up orphaned S3 files with admin privileges [c45dae07]
* feat: Add periodic cleanup task for orphaned S3 files and integrate with existing cleanup framework [5006544b]
* feat: Implement duplicate report checking and handling in MultiQC data processing [797ff096]
* feat: Enhance MultiQC component with interactive metadata support and theme integration [ff96348e]
* feat: Add compatibility aliases and access token handling in MultiQCDashboardComponent [a0431d48]
* feat: Add sample filtering and theme support to MultiQC figures with interactive callbacks [a5b100b8]
* feat: Implement MultiQC FastQC Dashboard with dynamic sample filtering and plot updates [0dd1a74d]
* feat: Add S3 file access configuration options to .env for improved performance [830fa957]
* feat: Enhance MultiQC component handling with improved metadata processing and layout adjustments [56e402ea]
* feat: Enhance MultiQC component with logo overlay and improved metadata handling [6081d90d]
* feat: Implement S3 mounting functionality with dynamic credentials in run_dash.sh [9314e616]
* feat: Add MultiQC tools metadata JSON file with detailed statistics and extraction info [4a4d5c74]
* feat: Add S3 caching configuration and enhance S3 file handling in MultiQC visualization [74c02cef]
* feat: Enhance MultiQC metadata loader and table processing with YAML support and modify functions [98792f7a]
* feat: Refactor MultiQC data processing and enhance dashboard functionality with argument parsing [b2ff074b]
* feat: Implement MultiQC Table with Data Bars using parquet data and metadata [4c87f0ab]
* feat: ongoing multiqc feat [056762bd]
* feat: Add fsspec and s3fs to conda environment; include multiqc in project dependencies [1d049ad0]
...
* fix: Add Redis service with healthcheck and volume configuration to docker-compose [444e5b56]
* fix: Enhance CI workflow by adding uv installation and Python setup with caching [0f94db1e]
* fix: Comment out unused add_filter function and pandera import in test_deltatables_utils [4fc62356]
* fix: Comment out pandera dependency for pandas and polars in dev requirements [dcc5c2f8]
* fix: Update CI workflow to clean up conflicting polars packages and ensure correct installation of polars-lts-cpu [f3fc77c5]
* fix: Update polars installation and modify pandera dependency for dev requirements [172c3821]
* fix: Comment out pandera dependency for pandas to simplify dev requirements [0fb1e9e4]
* fix: Simplify dependency installation process and verify polars installation [d196bc76]
* fix: Update ensure_owners_and_viewers_are_unique method to use instance variables [66df0a53]
* fix: Add MultiQC to quality check dependencies in CI workflow [725060cb]
* fix: Update mock path handling in MultiQC processor tests to improve directory iteration [8595bd8f]
* fix: Update patch targets in MultiQC processor tests for correct module referencing [7ef56c57]
* fix: Pin MultiQC version to 1.31.0 and update polars-lts-cpu dependency to include extra features [312ff64f]
* fix: Update layout IDs to match component index to prevent layout destruction on dashboard reload [9ccbd010]
* fix: Adjust dashboard and draggable grid styles for improved layout and spacing [1277dbb8]
* fix: Update default dimensions for components to fit 48-column grid layout [bc7b72fc]
* fix: Retrieve the last DeltaTableAggregated entry instead of the first in get_deltatable endpoint [570d6b45]
* fix: Adjust button height in selected and unselected styles for consistency [cf4bba29]
* fix: Refactor project data update logic in consolidated API callbacks [097e2331]
* fix: Increase height of notes footer content for better visibility [857a994b]
* fix: Reduce interval for SVG trigger to improve loading responsiveness [c0874944]
* fix: Update Celery worker command to correctly point to celery_app module [6f7d4678]
* fix: Update live interactivity handling and adjust button visibility in header component [028b9d37]
* fix: Update polars dependency to polars-lts-cpu==1.19.0 in pyproject.toml [454e62eb]
* fix: Increase default worker count to 4 for FastAPI and Dash configurations [2328b565]
* fix: Update polars dependency to polars-lts-cpu==1.19.0 in conda and pyproject configurations [5f3200a2]
* fix: Update sample identifier in metadata CSV and adjust MultiQC configuration for inner join [198b71fc]
