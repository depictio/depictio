...
# Set the variable to the empty string to restore that unbounded default.
#
...
echo "🔧 CELERY WORKER: Workers = $CELERY_WORKERS, max tasks/child = ${CELERY_MAX_TASKS_PER_CHILD:-unlimited}"
