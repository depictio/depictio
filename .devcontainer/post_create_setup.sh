...
# Wait for the bundled S3 store (SeaweedFS, service `s3`)
wait_for_service s3 9000 "S3 (SeaweedFS)"
...
echo "   │  S3 admin UI      ${S3_CONSOLE_PORT:-${MINIO_CONSOLE_PORT:-9001}}                                     │"
echo "   └─────────────────────────────────────────────────────────┘"
echo ""
