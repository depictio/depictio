...
/**
 * Placeholder for the `cnv_profile` kind. The model side (roles, config, sampling,
 * metadata) is registered; the renderer is being written in parallel and
 * replaces this file wholesale.
 */
const CnvProfileRenderer: React.FC<Props> = ({ metadata }) => (
  <Alert color="gray" title="Copy-number profile">
