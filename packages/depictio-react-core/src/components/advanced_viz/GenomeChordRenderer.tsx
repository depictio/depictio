...
/**
 * Placeholder for the `genome_chord` kind. The model side (roles, config, sampling,
 * metadata) is registered; the renderer is being written in parallel and
 * replaces this file wholesale.
 */
const GenomeChordRenderer: React.FC<Props> = ({ metadata }) => (
  <Alert color="gray" title="Genome chord">
